...
import { faHistory, faFlag, faFootballBall, faMale, faFemale } from '@fortawesome/free-solid-svg-icons';
        ...
        <div>
            ...
            <div className="league-info">
                <div className="details">
                    <h2>{strLeague}</h2>
                    <h4> <FontAwesomeIcon icon={faHistory} />  Founded: {intFormedYear}</h4>
                    <h4><FontAwesomeIcon icon={faFlag} />  Country: {strCountry}</h4>
                    <h4><FontAwesomeIcon icon={faFootballBall} />  Sports Type: {strSport}</h4>
                    <h4><FontAwesomeIcon icon={strGender === "Male" ? faMale : faFemale} />  Gender: {strGender}</h4>
                </div>
